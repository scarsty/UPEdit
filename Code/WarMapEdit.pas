...
begin
  warViewportX := 0;
  warViewportY := 0;
  warBufferWidth := image1.Width;
  warBufferHeight := image1.Height;
  WarMapInitial := false;
...
begin
  ...
  warsmallbmp.PixelFormat := pf24bit;  { 改为24bit RGB格式 }
  waropbmp.PixelFormat := pf24bit;     { 改为24bit RGB格式 }
  warbufbmp.PixelFormat := pf24bit;    { 改为24bit RGB格式 }
...
begin
  ...
  begin
    ...
    FastBitmapCopy(waropbmppng, waropbmppng.Canvas.ClipRect, warbufbmppng, warbufbmppng.Canvas.ClipRect);
  end;
