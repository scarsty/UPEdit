...
uses
  ...
  Dialogs, head, StdCtrls, ExtCtrls, imzObject, inifiles;
...
begin
 ...
 // for I := 0 to MAPBMP1.Height - 1 do
  //  Move(@tempMapData.data[i][0], MAPBMP1.ScanLine[I], MAPBMP1.Width * 3);
 ...
 // for I := 0 to MAPBMP1.Height - 1 do
  //  Move(MAPBMP1.ScanLine[I], @tempMapData.data[i][0], MAPBMP1.Width * 3);
...
procedure TForm93.FormClose(Sender: TObject; var CloseAction: TCloseAction);
begin
  memo1.Clear;
end;
