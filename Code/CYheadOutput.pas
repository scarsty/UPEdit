...
begin
  ...
  Form90.Label1.Caption := '输出' + inttostr(nowoutputnum) + '/' + inttostr(CYheadnum);
end;
...
begin
  ...
  begin
    ...
    showmessage('正在导出 PNG 图片中，请耐心等待后再进行操作。');
end;
...
begin
  ...
  Form90.ProgressBar1.Position := 0;
  Form90.Label1.Caption := '输出0/' + inttostr(CYheadnum);
  nowoutputnum := 0;
end;
  ...
  initialCYheadthread;
    ...
    begin
      ...
      begin
        ...
        filename := CYheaddir + '测试头像' + inttostr(I + 1) + '.png';
