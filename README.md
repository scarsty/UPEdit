...
基本由ai转换，除了画地图功能其他大致正常，但是问题在此修改器目前只有这个功能还不能被其他工具取代。

lcl存在大量兼容性和性能问题，突出的几个是：BitMap设置为8bit，但实际仍是24bit。CopyRect无效，刷新时机纯胡凑。在浪费大量request之后，因ai出现了bug，恢复时误删了大量修改，最后放弃。